...
public class DatabaseConfig {
    ...
    private static final String USER = "rm563089";
    private static final String PASSWORD = "180207";
    ...
    public static void testConnection() {
        try (Connection conn = getConnection()) {
            System.out.println("Teste de conexão com Oracle: OK!");
        } catch (SQLException e) {
            System.out.println(" Falha no teste de conexão: " + e.getMessage());
        }
    }
}